    ...
    public partial class CleanupInpNames : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                SET ""InpName"" = SUBSTR(""InpName"", INSTR(""InpName"", '_') + 1)
                WHERE INSTR(""InpName"", '_') BETWEEN 1 AND 4
                  AND SUBSTR(""InpName"", 1, 1) GLOB '[0-9]'
                  AND LENGTH(""InpName"") > INSTR(""InpName"", '_');
            ");
            ...
            migrationBuilder.Sql(@"
                ...
                WHERE ""InpName"" LIKE '%_1a';
            ");

            // Remove _js12B_N iteration suffixes (e.g. _js12B_100, _js12B_50, _js12B_60)
            migrationBuilder.Sql(@"
                UPDATE ""StructureExamples""
                SET ""InpName"" = SUBSTR(""InpName"", 1, INSTR(""InpName"", '_js12B') - 1)
                WHERE ""InpName"" LIKE '%_js12B%';
            ");
